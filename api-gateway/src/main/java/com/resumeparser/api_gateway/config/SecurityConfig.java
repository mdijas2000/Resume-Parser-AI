...
import com.resumeparser.api_gateway.filter.JwtAuthFilter;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
		http.csrf(csrf -> csrf.disable())
			...
			.authorizeHttpRequests(auth-> auth
					...
					.requestMatchers("/auth/login","/auth/register","/eureka/**","/error","/api/parser/upload","/api/parser/llmtest").permitAll()
